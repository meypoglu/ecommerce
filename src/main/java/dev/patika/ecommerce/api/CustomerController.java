...
public class CustomerController {
    ...
    public CustomerController(ICustomerService categoryService, IModelMapperService modelMapper) {
    ...
    public ResultData<CustomerResponse> save(@Valid @RequestBody CustomerSaveRequest customerSaveRequest) {
        ...
        this.categoryService.save(saveCustomer);
    ...
    public ResultData<CustomerResponse> get(@PathVariable("id") int id) {
        Customer customer = this.categoryService.get(id);
    ...
    public ResultData<CursorResponse<CustomerResponse>> cursor(@RequestParam(name = "page", required = false, defaultValue = "0") int page,
        ...
        {
            Page<Customer> categoryPage = this.categoryService.cursor(page, pageSize);
            Page<CustomerResponse> categoryResponsePage = categoryPage.map(customer -> this.modelMapper.forResponse().map(customer, CustomerResponse.class));
    ...
    public ResultData<CustomerResponse> update(@Valid @RequestBody CustomerUpdateRequest customerUpdateRequest) {
        ...
        this.categoryService.update(updateCustomer);
